...
@section('content')
    <div class="body flex-grow-1 px-3">
        <div class="container-lg">
            ...
            <form action="{{ route('faskes.tindakan.update', Crypt::encrypt($tindakan->kode_tindakan)) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                readonly value="{{ $tindakan->kode_tindakan }}">
                                                            @error('kode_tindakan')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control @error('detail_tindakan') is-invalid @enderror" id="detail_tindakan" type="text"
                                                                name="detail_tindakan">{{ $tindakan->detail_tindakan }}</textarea>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                value="{{ $tindakan->tarif_tindakan }}" type-currency="IDR">
