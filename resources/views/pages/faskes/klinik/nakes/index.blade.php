        ...
        $(function() {
            $('#faskes').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'detail_jabatan.nama_jabatan',
                    },
                    {
                        data: 'status',
