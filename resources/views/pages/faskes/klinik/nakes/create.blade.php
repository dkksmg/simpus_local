...
@section('content')
    <div class="body flex-grow-1 px-3">
        <div class="container-lg">
            ...
            <form action="{{ route('faskes.nakes.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="card mb-4">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select" name="jabatan_nakes">
                                                                ...
                                                                @foreach ($jabatan as $jab)
                                                                    <option value="{{ $jab->id }}"
                                                                        {{ $jab->id == old('jabatan_nakes') ? 'selected' : '' }}>
                                                                        {{ $jab->nama_jabatan }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select" name="status_nakes">
                                                                <option value=""></option>
                                                                <option value="active"
                                                                    {{ old('status_nakes') == 'active' ? 'selected' : '' }}>
                                                                    Aktif</option>
                                                                <option value="inactive"
                                                                    {{ old('status_nakes') == 'inactive' ? 'selected' : '' }}>
                                                                    Tidak aktif</option>
                                                            </select>
                                                            @error('status_nakes')
                                                                <div class="alert alert-danger">{{ $message }}</div>
