...
@section('content')
    <div class="body flex-grow-1 px-3">
        <div class="container-lg">
            ...
            <form action="{{ route('faskes.poli.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="card mb-4">
                                        ...
                                        <div class="tab-pane p-3 active preview" role="tabpanel">
                                            <div class="row g-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="status_poli">Status
                                                                Poli</label>
                                                            <select
                                                                ...
                                                                <option value=""></option>
                                                                <option value="active"
                                                                    {{ old('status_poli') == 'active' ? 'selected' : '' }}>
                                                                    Aktif</option>
                                                                <option value="inactive"
                                                                    {{ old('status_poli') == 'inactive' ? 'selected' : '' }}>
                                                                    Tidak Aktif</option>
                                                            </select>
                                                            @error('status_poli')
                                                                <div class="alert alert-danger">{{ $message }}</div>
