...
@section('content')
    <div class="body flex-grow-1 px-3">
        <div class="container-lg">
            <div class="fs-2 fw-semibold">Ubah Data Faskes</div>
                    ...
                    <div class="example">
                        <div class="tab-content rounded-bottom">
                            <div class="tab-pane p-3 active preview" role="tabpanel">
                                <div class="row">
                                    <div class="col-auto">
                                        <label for="btnGroupAddon2">Perbarui Data Klinik</label>
                                    </div>
                                    <div class="col-auto">
                                        <div class="input-group">
                                            <input class="form-control" type="text" placeholder="Masukkan Kode Klinik"
                                                name="kode_klinik" id="kode_klinik" readonly disabled
            ...
            <form action="{{ route('faskes.update', Crypt::encrypt($faskes->kode_faskes)) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-10">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="mb-3">
                                                        ...
                                                        <input
                                                            ...
                                                            value="{{ $faskes->user->email }}" id="email_faskes"
                                                ...
                                                <div class="col-md-5">
                                                    <div class="mb-3">
                                                        ...
                                                        <select
                                                            ...
                                                            <option value=""></option>
                                                            <option value="KLINIK"
                                                                {{ $faskes->user->role == 'KLINIK' ? 'selected' : '' }}>
                                                                Klinik
                                                            </option>
                                                        </select>
                                                        @error('role_faskes')
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input
                                                            ...
                                                            value="{{ $faskes->nama_faskes }}" readonly>
                                                        @error('nama_faskes')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input
                                                            ...
                                                            value="{{ $faskes->nama_pimpinan }}" id="pj_faskes"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input
                                                            ...
                                                            value="{{ $faskes->phone_faskes }}" readonly>
                                                        @error('kontak_faskes')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control-plaintext @error('alamat_faskes') is-invalid @enderror" id="alamat_faskes"
                                                            name="alamat_faskes" readonly style="resize: none">{{ $faskes->alamat_faskes }}</textarea>
                                                        @error('alamat_faskes')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input
                                                            ...
                                                            value="{{ \Carbon\Carbon::parse($faskes->ijin_berakhir)->format('d-m-Y') }}" />
                                                        @error('tgl_berakhir')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
