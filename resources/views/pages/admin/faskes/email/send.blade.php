                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="{{ route('home') }}"
                                ...
                                <img src="http://119.2.50.170:9093/penilaian_klinik/assets/img/pemkot.png"
                                ...
                                <br>
                                Sistem Informasi Manajemen Elektronik Klinik
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Berikut kami lampirkan data untuk masuk ke akun SIM-e Klinik Anda.</p>
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;"width="100px">
                                                                            Email
                                                                        </td>
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Pastikan Anda menyimpan alamat email dan password yang telah dikirim. Jika
                                            anda ingin mengubah password dapat klik <a
                                                href="{{ route('password.request') }}">disini</a>.</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Alamat Website SIM-e Klinik klik <a href="{{ route('home') }}"
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 10px; font-weight: bold;">
                                            Dinas Kesehatan Kota Semarang<br>
                                            Jl. Pandanaran No.79, Mugassari, Kec. Semarang Selatan, Kota Semarang, Jawa
                                            Tengah 50249<br>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2022 {{ config('app.name', 'Laravel') }}. All rights reserved.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
